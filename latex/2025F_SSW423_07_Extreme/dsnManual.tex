...
\renewcommand{\UseCaseLabel}[2]{\FamilyLabel{#1}{#2}}
\renewcommand{\UseCaseName}[2]{\FamilyName{#1}{#2}}
\renewcommand{\UseCaseReference}[2]{\FamilyNameReferenceKind{#1}{#2}{UC}{_}}

% Use Case name with stacked (WS) reference
\renewcommand{\UseCaseNameWSReference}[2]{%
  \begin{tabular}{c}
    \UseCaseName{#1}{#2} \\
...
\renewcommand{\UseCaseNameWIReference}[2]{%
