...
\begin{titlepage}
        \title{Extending Trustworthy Natural Language Interfaces for Quantum Optimization \input{version.tex}
}
        \author{Enoch Chan, Benjamin Moks, Kyle Ponte \\ Stevens.edu }
