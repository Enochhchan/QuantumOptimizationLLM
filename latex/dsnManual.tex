...
% \newcommand{\UseCaseLabel}[2]{\FamilyLabel{#1}{#2}}
% \newcommand{\UseCaseName}[2]{\FamilyName{#1}{#2}}
% \newcommand{\UseCaseReference}[2]{\FamilyNameReferenceKind{#1}{#2}{UC}{_}}

% % Use Case name with stacked (WS) reference
% \newcommand{\UseCaseNameWSReference}[2]{%
%   \begin{tabular}{c}
%     \UseCaseName{#1}{#2} \\
...
% \newcommand{\UseCaseNameWIReference}[2]{%
