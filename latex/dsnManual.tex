...
\providecommand{\UseCaseLabel}[2]{\FamilyLabel{#1}{#2}}
\providecommand{\UseCaseName}[2]{\FamilyName{#1}{#2}}
\providecommand{\UseCaseReference}[2]{\FamilyNameReferenceKind{#1}{#2}{UC}{_}}

% Use Case name with stacked (WS) reference
\providecommand{\UseCaseNameWSReference}[2]{%
  \begin{tabular}{c}
    \UseCaseName{#1}{#2} \\
    (\UseCaseReference{#1}{#2})
  \end{tabular}
}

% Use Case name with inline (WI) reference
\providecommand{\UseCaseNameWIReference}[2]{%
  \UseCaseName{#1}{#2} (\UseCaseReference{#1}{#2})
}
...
\include{dsnTeamDeclaration}
% \include{dsnDevelopmentPlan}
\include{dsnStakeholders}
